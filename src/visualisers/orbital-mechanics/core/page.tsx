...
export default function OrbitalMechanicsPage() {
  return (
    <main className='min-h-screen'>
      ...
      {/* Stage 4a: The Shape of Orbits + Mission Map */}
      <section className='px-4 md:px-8 lg:px-12 pb-12 md:pb-16 lg:pb-20'>
        <div className='grid grid-cols-1 lg:grid-cols-[3fr_7fr] gap-8 lg:gap-12 mb-8'>
          <h2 className='text-3xl md:text-4xl font-bold tracking-[-0.03em]'>
            The Shape of Orbits
      ...
      {/* Stage 4b: The Hohmann Transfer + Animation */}
      <section className='px-4 md:px-8 lg:px-12 pb-12 md:pb-16 lg:pb-20'>
        <div className='grid grid-cols-1 lg:grid-cols-[3fr_7fr] gap-8 lg:gap-12 mb-8'>
          <h2 className='text-3xl md:text-4xl font-bold tracking-[-0.03em]'>
      ...
      {/* Stage 4c: The Oberth Effect + Designer */}
      <section className='px-4 md:px-8 lg:px-12 pb-12 md:pb-16 lg:pb-20'>
        <div className='grid grid-cols-1 lg:grid-cols-[3fr_7fr] gap-8 lg:gap-12 mb-8'>
          <h2 className='text-3xl md:text-4xl font-bold tracking-[-0.03em]'>
            The Oberth Effect
          ...
          <div className='space-y-4 text-white/70 leading-relaxed'>
            ...
            <p>
              This is why Hohmann transfers work so well. Both burns happen at the fastest points in the orbit. Burning at these points extracts maximum value from every kilogram of fuel.
            </p>
          </div>
        </div>
        <div className='bg-white rounded-xl overflow-hidden'>
      ...
      {/* Stage 4d: Real Missions + Storyboard */}
      <section className='px-4 md:px-8 lg:px-12 pb-12 md:pb-16 lg:pb-20'>
        <div className='grid grid-cols-1 lg:grid-cols-[3fr_7fr] gap-8 lg:gap-12 mb-8'>
          <h2 className='text-3xl md:text-4xl font-bold tracking-[-0.03em]'>
            Real Missions
          ...
          <div className='space-y-4 text-white/70 leading-relaxed'>
            ...
            <p>
              Artemis uses a more complex trajectory involving a near-rectilinear halo orbit (NRHO). It takes longer but requires less fuel and provides better geometry for lunar surface access.
            </p>
          </div>
        </div>
        <div className='bg-white rounded-xl overflow-hidden'>
      ...
      <section className='px-4 md:px-8 lg:px-12 pb-12 md:pb-16 lg:pb-20'>
        <div className='grid grid-cols-1 lg:grid-cols-[3fr_7fr] gap-8 lg:gap-12'>
          ...
          <div className='space-y-4 text-white/70 leading-relaxed'>
            ...
            <p>
              These six numbers completely define where an object is and where it&apos;s going. Change any one, and you get a different orbit. Spacecraft manoeuvres are really just carefully calculated changes to these elements.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className='px-4 md:px-8 lg:px-12 pb-12 md:pb-16 lg:pb-20'>
        <div className='grid grid-cols-1 lg:grid-cols-[3fr_7fr] gap-8 lg:gap-12'>
          ...
          <div className='space-y-4 text-white/70 leading-relaxed'>
            <p>
              Everything we&apos;ve discussed assumes only one gravitational body matters at a time. In reality, a spacecraft travelling to the Moon feels both Earth&apos;s and the Moon&apos;s gravity (and the Sun&apos;s, and...).
            </p>
            <p>
