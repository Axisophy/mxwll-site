        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-16'>
          ...
          <div className='lg:col-span-2'>
            ...
            <div className='flex flex-wrap gap-2 mt-4 md:mt-6 lg:mt-8'>
              <span className='px-3 py-1 text-xs bg-[var(--bg-secondary)] text-[var(--text-tertiary)]'>Interactive Visualisation</span>
              ...
              <span className='px-3 py-1 text-xs bg-[var(--bg-secondary)] text-[var(--text-tertiary)]'>GPGPU</span>
            </div>
          </div>
