...
const NuclideChart = dynamic(
  () => import('@/visualisers/nuclide-chart/core/NuclideChart'),
  { ssr: false }
)
      ...
      <section className="px-4 md:px-8 lg:px-12 pb-12 md:pb-16 lg:pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-[3fr_7fr] gap-8 lg:gap-12">
          ...
          <div className="space-y-4 font-sabon text-[var(--text-secondary)] leading-relaxed">
            ...
            <p>
              Uranium-238 has a half-life of 4.5 billion years - nearly the age of Earth. That&apos;s why there&apos;s still uranium in the ground. Carbon-14 has a half-life of 5,730 years - long enough to date ancient artefacts, short enough that it&apos;s continuously replenished by cosmic rays.
            </p>
            <p>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm font-sabon">
                  <li>
                    ...
                    <span className="text-[var(--text-tertiary)] ml-2">Memoir through chemistry</span>
                  </li>
                  <li>
                    <a
                    ...
                    <span className="text-[var(--text-tertiary)] ml-2">Nuclear physics in historical context</span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm font-sabon">
                  <li>
                    ...
                    <span className="text-[var(--text-tertiary)] ml-2">Strange matter and nuclear stability</span>
                  </li>
                </ul>
              </div>
