...
const labItems = [
  // --- Live ---
  {
    ...
    tags: ['SVG', 'Astrophysics', 'Interactive'],
  ...
  },
  {
    ...
    tags: ['Canvas', 'Astronomy', 'Scrollytelling'],
  ...
  },
  {
    ...
    tags: ['WebGL2', 'Astronomy', 'Particle System'],
  ...
  },
  {
    ...
    tags: ['Canvas', 'Space', 'Physics Simulation'],
  ...
  },
  {
    ...
    tags: ['Canvas', 'Mathematics', 'Generative'],
    slug: '/lab/fractals',
    status: 'Live',
  },
  {
    ...
    tags: ['Three.js', 'Astronomy', 'Particle Simulation'],
  ...
  },
  {
    ...
    tags: ['Canvas', 'Nuclear Physics', 'Interactive'],
  ...
  },
  {
    ...
    tags: ['SVG', 'Graph Theory', 'Simulation'],
  ...
  },
  {
    ...
    tags: ['Canvas', 'Geophysics', 'Interactive'],
  ...
  },
  {
    ...
    tags: ['Interactive', 'Game Theory', 'Networks'],
  ...
  },
  {
    ...
    tags: ['Interactive', 'Strategy', 'Economics'],
    ...
    <div className="min-h-screen">
      ...
      <section className="px-4 md:px-8 lg:px-12 pt-24 md:pt-28 lg:pt-32 pb-12">
        <div className="max-w-4xl">
          <h1 className="font-display text-4xl md:text-5xl font-bold tracking-[-0.03em] mb-6">Lab</h1>
